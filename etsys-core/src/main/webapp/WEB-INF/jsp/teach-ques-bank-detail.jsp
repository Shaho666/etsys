...
<body class="skin-black">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<div id="con-center" class="row"
			...
			<%-- <div style="padding: 20px 200px 10px;">
				<a href="/questionBank/showPojoPage/${course.courseId }"
					class="btn btn-primary btn-sm">增加题目</a>
			</div> --%>
			<div style="padding: 20px 200px 10px;">
				<p class="text-danger">该题目信息如下：</p>
				<table class="table table-hover">
					<thead>
						<tr class="warning">
							<th>题目编号</th>
					...
					<tbody>
						<tr class="success">
							...
							<td>${question.queDegree }</td>
							<td>${question.queState }</td>
