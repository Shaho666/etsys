					...
					<tbody>
						<c:forEach items="${tests }" var="test">
							<tr class="success">
								...
								<td><c:if test="${test.finished == true }"><a
									href="/testPaper/generate?testId=${test.testId }">进入考试</a></c:if>
									<c:if test="${test.finished == false }"><p style="color: red">考试已完成</p></c:if></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
